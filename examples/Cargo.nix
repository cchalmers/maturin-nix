  ...
  internal = rec {
    ...
    crates = {
      ...
      "indoc" = rec {
        ...
        version = "1.0.6";
        edition = "2018";
        sha256 = "0vkxja3mdjgq9hjbsvq4ql9dbfdphw01hmbqndldkr9rjc0vv805";
        procMacro = true;
        authors = [
      ...
      "mm" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./mm; };
        dependencies = [
          {
            name = "ndarray";
            packageId = "ndarray";
      ...
      "mmpy" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./mmpy; };type = [ "cdylib" ];
        dependencies = [
          {
            name = "mm";
            packageId = "mm";
      ...
      "ndarray" = rec {
        ...
        version = "0.15.4";
        edition = "2018";
        sha256 = "1a0wdaxz6i3ij1148vaqlikjzbqjl9dag1fkng95h1l3c9kkxhny";
        authors = [
      ...
      "numpy" = rec {
        ...
        version = "0.16.2";
        edition = "2018";
        sha256 = "0ibwvsa0bxcnxm9pbhlva4d76xskhvxd9nf1rfbzqfcsa9lf2fiq";
        authors = [
      ...
      "printer" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./printer; };type = [ "cdylib" ];
        dependencies = [
          {
            name = "pyo3";
            packageId = "pyo3";
      ...
      "pyo3" = rec {
        ...
        version = "0.16.5";
        edition = "2018";
        sha256 = "1p5kjsj3jdw2gnahdjrzljmi93w3nxdp11qq8x3i80b0a3l04qqy";
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "abi3" "abi3-py310" "abi3-py37" "abi3-py38" "abi3-py39" "default" "extension-module" "indoc" "macros" "pyo3-macros" "pyproto" "unindent" ];
      };
      "pyo3-build-config" = rec {
        crateName = "pyo3-build-config";
        version = "0.16.5";
        edition = "2018";
        sha256 = "1j2jj5qnnpagi3gvkwjpydcxfsd5qv3vmpghnaqs7n1mdia5pdmm";
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "abi3" "abi3-py310" "abi3-py37" "abi3-py38" "abi3-py39" "default" "extension-module" "resolve-config" ];
      };
      "pyo3-ffi" = rec {
        crateName = "pyo3-ffi";
        version = "0.16.5";
        edition = "2018";
        sha256 = "0avls4q393nmzhb124zg6kp5lj6xzy2f6qx564qa7b614xqs0xf2";
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "abi3" "abi3-py310" "abi3-py37" "abi3-py38" "abi3-py39" "default" "extension-module" ];
      };
      "pyo3-macros" = rec {
        crateName = "pyo3-macros";
        version = "0.16.5";
        edition = "2018";
        sha256 = "1xwh7sl4n73746q80n5m5afd261zg0kxcqfnlr89ik7vbd4c8kr8";
        procMacro = true;
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
        ...
        resolvedDefaultFeatures = [ "abi3" "pyproto" ];
      };
      "pyo3-macros-backend" = rec {
        crateName = "pyo3-macros-backend";
        version = "0.16.5";
        edition = "2018";
        sha256 = "1bvzvdx2a6hhliny12n2vy7v7gbsgzanxjckjr1cbxbkizss1gak";
        authors = [
          "PyO3 Project and Contributors <https://github.com/PyO3>"
        ];
        dependencies = [
      ...
      "unindent" = rec {
        ...
        version = "0.1.9";
        edition = "2018";
        sha256 = "0i1sjxlhw7rbvq47xgk0lixgpnswfyks21ks6zgzfw75lccybzjj";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
